...
namespace AppXamarin.Models
{
    ...
    public partial class GiphyModel
    {
        public static GiphyModel FromJson(string json) => JsonConvert.DeserializeObject<GiphyModel>(json, AppXamarin.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GiphyModel self) => JsonConvert.SerializeObject(self, AppXamarin.Models.Converter.Settings);
    }
